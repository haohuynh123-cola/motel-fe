      ...
      <a-layout style="min-height: 100vh">
            ...
            >
                  ...
                  >
                        <div
                              v-if="!collapsed"
                              class="flex items-center gap-3 w-full px-4 justify-start"
                        >
                              <div
                              ...
                              <span
                                    class="text-white text-lg font-bold tracking-wide truncate"
                                    >Tro-Go</span
                              >
                        </div>
                        <div
            ...
            <a-layout class="bg-gray-50 transition-all duration-300">
                        ...
                        <div class="flex items-center gap-5">
                              ...
                              >
                                    ...
                                    >
                                          ...
                                          >
                                                <span
                                                      class="text-sm font-bold text-gray-700 leading-tight"
                                                      >Admin User</span
                                                >
                                                <span
                                    ...
                                    <template #overlay>
                                          <a-menu
                                                class="w-56 p-2 rounded-xl shadow-xl border border-gray-100 mt-2"
                                          >
                                                <div
                                                      class="px-4 py-3 border-b border-gray-100 mb-2"
                                                >
                                                      <p
                                                            class="text-sm font-semibold text-gray-800 m-0"
                                                      >
                                                            Admin User
                                                      </p>
                                                      <p
                                                            class="text-xs text-gray-500 m-0 mt-0.5"
                                                      >
                                                            admin@trogo.vn
                                                      </p>
                                                </div>
                  ...
                  <!-- Main Content Area -->
                  <a-layout-content
                        style="margin: 24px; min-height: calc(100vh - 112px)"
                  >
                        <div
